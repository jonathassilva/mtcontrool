...
class RunsController extends Controller {
    ...
    public function actionView($id) {
    	...
    	*/
    	...
    	$quantidadePass = count(TestRun::model()->findAllByAttributes(array('status'=>1 , 'id_runs'=>$id)));
    	$quantidadeFail = count(TestRun::model()->findAllByAttributes(array('status'=>2 , 'id_runs'=>$id)));
    	$quantidadePending = count(TestRun::model()->findAllByAttributes(array('status'=>0 , 'id_runs'=>$id)));
    ...
    public function actionCreate() {
        ...
        if (isset($_POST ['Runs'])) {
            ...
            if ($model->save()) {
            	...
            	$this->redirect(array('runs/quest', 'id' => $model->id));
            }
        }
    ...
    public function actionQuest($id) {
    	...
    	if ($plataforma->name == "Android"){
    		$this->render('quest', array('id'=>$id, 'plataforma'=>'Android'));
    	}else if ($plataforma->name == "iOS"){
    		$this->render('quest', array('id'=>$id, 'plataforma'=>'iOS'));
        }else if ($plataforma->name == "Windows Phone"){
                $this->render('quest', array('id'=>$id, 'plataforma'=>'Windows Phone'));
        }
    }
